...
#ifndef GPSTOM_MATRIX_OPERATORS_HPP
#define GPSTOM_MATRIX_OPERATORS_HPP
...
namespace gpstom
{
                               ...
                               Vector<T>& sv, const T tol=T(1.e-8)) throw (MatrixException)
   {
      ...
      /**
       * Inverts the square symmetric positive definite matrix M using
      ...
      throw (MatrixException)
   {
      ...
      gpstom::CholeskyCrout<double> CC;
      CC(m);
      ...
      throw (MatrixException)
   {
      if (v.size() != m.cols())
      {
         gpstom::MatrixException e("Incompatible dimensions for Vector * Matrix");
         GPSTOM_THROW(e);
      }
