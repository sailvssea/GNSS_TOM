...
namespace gpstom
{
      ...
      throw(GeometryException)
   {
      if (right.size() != 3)
      {
         GPSTOM_THROW(GeometryException("Incorrect vector size"));
      }
       ...
       throw(GeometryException)
   {
      ...
      if (mag <= 1e-14)
      	GPSTOM_THROW(GeometryException("Divide by Zero Error"));
      ...
      throw(GeometryException)
   {
      ...
      if (test < 1.0e-14)
      {
         GPSTOM_THROW(GeometryException("azAngle(), failed p1+p2 test."));
      }
