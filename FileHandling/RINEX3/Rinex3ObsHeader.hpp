...
#ifndef GPSTOM_RINEX3OBSHEADER_HPP
#define GPSTOM_RINEX3OBSHEADER_HPP
...
namespace gpstom
{
       ...
       * @sa gpstom::Rinex3ObsData and gpstom::Rinex3ObsStream.
   ...
   public:
      ...
      gpstom::Triple antennaPosition;   ///< APPROX POSITION XYZ
      gpstom::Triple antennaDeltaHEN;   ///< ANTENNA: DELTA H/E/N
      gpstom::Triple antennaDeltaXYZ;   ///< ANTENNA: DELTA X/Y/Z
      std::string antennaSatSys;       ///< ANTENNA P.CTR BLOCK: SAT SYS
      std::string antennaObsCode;      ///< ANTENNA P.CTR BLOCK: OBS CODE
      gpstom::Triple antennaPhaseCtr;   ///< ANTENNA P.CTR BLOCK: PCTR POS
      gpstom::Triple antennaBsightXYZ;  ///< ANTENNA B.SIGHT XYZ
      double        antennaZeroDirAzi; ///< ANTENNA ZERODIR AZI
      gpstom::Triple antennaZeroDirXYZ; ///< ANTENNA ZERODIR XYZ
      gpstom::Triple centerOfMass;      ///< vehicle CENTER OF MASS: XYZ
      ...
      void writeHeaderRecords(FFStream& s) const
         throw(FFStreamError, gpstom::StringUtils::StringException);
...
#endif // GPSTOM_RINEX3OBSHEADER_HPP
