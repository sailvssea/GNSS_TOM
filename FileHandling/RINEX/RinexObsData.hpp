...
namespace gpstom
{
       ...
       *
       * @sa gpstom::RinexObsStream and gpstom::RinexObsHeader.
   ...
   public:
      ...
      typedef std::map<RinexObsType, gpstom::RinexDatum> RinexObsTypeMap;
         /// map from SatID to RinexObsTypeMap.
      typedef std::map<gpstom::SatID, RinexObsTypeMap> RinexSatMap;

      gpstom::CommonTime time;    ///< the time corresponding to the observations
      ...
      RinexObsHeader auxHeader;///< auxiliary header records (epochFlag 2-5)
         ...
         /// Constructor.
      RinexObsData() : time(gpstom::CommonTime::BEGINNING_OF_TIME){}
