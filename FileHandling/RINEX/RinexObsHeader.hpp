...
// and Rinex3NavHeader
#ifndef GPSTOM_EXTRAWAVEFACT
#define GPSTOM_EXTRAWAVEFACT
   ...
   struct ExtraWaveFact
   {
       ...
       * @sa gpstom::RinexObsData and gpstom::RinexObsStream.
...
//         version = 2.11;
      ...
      gpstom::Triple antennaPosition;         ///< APPROXIMATE POSITION XYZ
      gpstom::Triple antennaOffset;           ///< ANTENNA: DELTA H/E/N
