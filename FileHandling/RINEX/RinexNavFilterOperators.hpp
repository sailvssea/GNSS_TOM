...
namespace gpstom
{
   ...
   struct RinexNavDataOperatorLessThanFull : 
      public std::binary_function<gpstom::RinexNavData, 
                                  gpstom::RinexNavData, bool>
   {
   public:
      bool operator()(const gpstom::RinexNavData& l,
                      const gpstom::RinexNavData& r) const
      {
   ...
   struct RinexNavHeaderTouchHeaderMerge :
      public std::unary_function<gpstom::RinexNavHeader, bool>
   {
   public:
      ...
      bool operator()(const gpstom::RinexNavHeader& l)
      {
         if (firstHeader)
         {
            theHeader = l;
      ...
      bool firstHeader;
      gpstom::RinexNavHeader theHeader;
   };

      /// Filter based on PRN ID.
   struct RinexNavDataFilterPRN : 
      public std::unary_function<gpstom::RinexNavData,  bool>
   {
   public:
      ...
      bool operator()(const gpstom::RinexNavData& l) const
      {
