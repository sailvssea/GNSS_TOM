...
namespace gpstom
{
   ...
   RinexNavData::RinexNavData()
         : time(gpstom::CommonTime::BEGINNING_OF_TIME), PRNID(-1),
           ...
           idot(0), fitint(4)
   {
      time.setTimeSystem(gpstom::TimeSystem::GPS);
   }
      ...
      throw(StringException, FFStreamError)
   {
      try
      {
         ...
         time = CivilTime(yr,mo,day,hr,min,sec,gpstom::TimeSystem::GPS).convertToCommonTime();
         if(ds != 0) time += ds;

         af0 = gpstom::StringUtils::for2doub(currentLine.substr(22,19));
         af1 = gpstom::StringUtils::for2doub(currentLine.substr(41,19));
         af2 = gpstom::StringUtils::for2doub(currentLine.substr(60,19));
      }
      ...
      throw(StringException, FFStreamError)
   {
      try
      {
         IODE = gpstom::StringUtils::for2doub(currentLine.substr(3,19));
         Crs = gpstom::StringUtils::for2doub(currentLine.substr(22,19));
         dn = gpstom::StringUtils::for2doub(currentLine.substr(41,19));
         M0 = gpstom::StringUtils::for2doub(currentLine.substr(60,19));
      }
      catch (std::exception &e)
      {
         FFStreamError err("std::exception: " +
      ...
      throw(StringException, FFStreamError)
   {
      try
      {
         Cuc = gpstom::StringUtils::for2doub(currentLine.substr(3,19));
         ecc = gpstom::StringUtils::for2doub(currentLine.substr(22,19));
         Cus = gpstom::StringUtils::for2doub(currentLine.substr(41,19));
         Ahalf = gpstom::StringUtils::for2doub(currentLine.substr(60,19));
      }
      catch (std::exception &e)
      {
         FFStreamError err("std::exception: " +
      ...
      throw(StringException, FFStreamError)
   {
      try
      {
         Toe = gpstom::StringUtils::for2doub(currentLine.substr(3,19));
         Cic = gpstom::StringUtils::for2doub(currentLine.substr(22,19));
         OMEGA0 = gpstom::StringUtils::for2doub(currentLine.substr(41,19));
         Cis = gpstom::StringUtils::for2doub(currentLine.substr(60,19));
      }
      catch (std::exception &e)
      {
         FFStreamError err("std::exception: " +
      ...
      throw(StringException, FFStreamError)
   {
      try
      {
         i0 = gpstom::StringUtils::for2doub(currentLine.substr(3,19));
         Crc = gpstom::StringUtils::for2doub(currentLine.substr(22,19));
         w = gpstom::StringUtils::for2doub(currentLine.substr(41,19));
         OMEGAdot = gpstom::StringUtils::for2doub(currentLine.substr(60,19));
      }
      catch (std::exception &e)
      {
         FFStreamError err("std::exception: " +
      ...
      throw(StringException, FFStreamError)
   {
      try
      {
         ...
         idot = gpstom::StringUtils::for2doub(currentLine.substr(3,19));
         codeL2 = gpstom::StringUtils::for2doub(currentLine.substr(22,19));
         toe_wn = gpstom::StringUtils::for2doub(currentLine.substr(41,19));
         L2P = gpstom::StringUtils::for2doub(currentLine.substr(60,19));
      ...
      throw(StringException, FFStreamError)
   {
      try
      {
         ...
         accuracy = gpstom::StringUtils::for2doub(currentLine.substr(3,19));
         SV_health = gpstom::StringUtils::for2doub(currentLine.substr(22,19));
         Tgd = gpstom::StringUtils::for2doub(currentLine.substr(41,19));
         IODC = gpstom::StringUtils::for2doub(currentLine.substr(60,19));
      ...
      throw(StringException, FFStreamError)
   {
      try
      {
         ...
         HOW_sec = gpstom::StringUtils::for2doub(currentLine.substr(3,19));
            ...
            //setXmitTime(HOW_sec);
         sf1XmitTime = HOW_sec;
         fitint = gpstom::StringUtils::for2doub(currentLine.substr(22,19));
      }
      catch (std::exception &e)
      {
         FFStreamError err("std::exception: " +
