...
namespace gpstom
{
   ...
   CommonTime gpstom::RinexObsData::previousTime;
   ...
   void RinexObsData::reallyGetRecord(FFStream& ffs)
      throw(std::exception, FFStreamError, gpstom::StringUtils::StringException)
   {
      RinexObsStream& strm = dynamic_cast<RinexObsStream&>(ffs);
      ...
      throw(FFStreamError)
   {
      ...
      catch (gpstom::Exception& e)
      {
         ...
         FFStreamError err("gpstom::Exception in parseTime(): " + text);
         GPSTOM_THROW(err);
      }
