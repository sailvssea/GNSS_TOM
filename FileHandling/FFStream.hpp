...
#ifndef GPSTOM_FFSTREAM_HPP
#define GPSTOM_FFSTREAM_HPP
...
namespace gpstom
{
   ...
   NEW_EXCEPTION_CLASS(EndOfFile, gpstom::FFStreamError);
   ...
   conditionalThrow(void) throw(FFStreamError)
   {
      ...
      {
         GPSTOM_THROW(mostRecentException);
      }
   }

}  // End of namespace gpstk
#endif   // GPSTOM_FFSTREAM_HPP
