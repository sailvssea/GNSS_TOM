...
#ifndef GPSTOM_FFTEXTSTREAM_HPP
#define GPSTOM_FFTEXTSTREAM_HPP
...
namespace gpstom
{
   ...
   public:
      ...
      void formattedGetLine( std::string& line,
         ...
         throw(EndOfFile, FFStreamError, gpstom::StringUtils::StringException);
