...
unsigned RinexNav_T :: hardCodeTest()
{
   ...
   try
   {
      gpstom::RinexNavStream inp(inputRinexNavExample.c_str());
      gpstom::RinexNavStream out(outputTestOutput.c_str(), std::ios::out);
      gpstom::RinexNavStream dmp(outputRinexDump.c_str(), std::ios::out);
      gpstom::RinexNavHeader header;
      gpstom::RinexNavData data;
      ...
      TUCMPFILE(inputRinexNavExample, outputTestOutput, 2);
         ...
         //------------------------------------------------------------
      gpstom::RinexNavStream inp2(outputTestOutput.c_str());
      gpstom::RinexNavStream out2(outputTestOutput2.c_str(), std::ios::out);
      gpstom::RinexNavHeader header2;
      gpstom::RinexNavData data2;
      ...
      gpstom::RinexNavStream inp3(outputTestOutput2.c_str());
      gpstom::RinexNavStream out3(outputTestOutput3.c_str() , std::ios::out);
      gpstom::RinexNavHeader header3;
      gpstom::RinexNavData data3;
...
unsigned RinexNav_T :: headerExceptionTest()
{
   ...
   std::string msg_expected    = ", should throw a gpstom::Exception";
   std::string msg_false_pass  = ", but threw no exception.";
   std::string msg_true_fail   = ", but instead threw an unknown exception.";

   try
   {
      gpstom::RinexNavStream InvalidLineLength(inputInvalidLineLength.c_str());
      gpstom::RinexNavStream NotaNavFile(inputNotaNavFile.c_str());
      gpstom::RinexNavStream UnknownHeaderLabel(inputUnknownHeaderLabel.c_str());
      gpstom::RinexNavStream IncompleteHeader(inputIncompleteHeader.c_str());
      gpstom::RinexNavStream UnsupportedRinex(inputUnsupportedRinex.c_str());
      gpstom::RinexNavStream BadHeader(inputBadHeader.c_str());
      gpstom::RinexNavStream out(outputTestOutputHeader.c_str(), std::ios::out);
      gpstom::RinexNavHeader Header;
...
unsigned RinexNav_T :: filterOperatorsTest()
{
   ...
   try
   {
      gpstom::RinexNavStream FilterStream1(inputFilterStream1.c_str());
      FilterStream1.open(inputFilterStream1.c_str(), std::ios::in);
      gpstom::RinexNavStream FilterStream2(inputFilterStream2.c_str());
      gpstom::RinexNavStream FilterStream3(inputFilterStream3.c_str());
      gpstom::RinexNavStream out(outputFilterOutput.c_str(), std::ios::out);

      gpstom::RinexNavHeader FilterHeader1;
      gpstom::RinexNavHeader FilterHeader2;
      gpstom::RinexNavHeader FilterHeader3;

      gpstom::RinexNavData FilterData1;
      gpstom::RinexNavData FilterData2;
      gpstom::RinexNavData FilterData3;
      gpstom::RinexNavData rndata;
      ...
      std::list<long> list;
      list.push_front(6);
      gpstom::RinexNavDataFilterPRN FilterPRN(list);
...
unsigned RinexNav_T :: castTest()
{
   ...
   gpstom::RinexNavStream out(outputTestOutput4.c_str(), std::ios::out);
   out << rnd;
   out.close();
...
unsigned RinexNav_T :: xmitReadTest()
{
   ...
   CommonTime expXmit = GPSWeekSecond(1886, 604200, gpstom::TimeSystem::GPS);
   in >> header;
