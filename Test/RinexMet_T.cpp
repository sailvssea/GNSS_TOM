...
{
   TestUtil test0;
   std::string dataFilePath = gpstom::getPathData();
   std::string tempFilePath = gpstom::getPathTestTemp();

      //----------------------------------------
      // Full file paths
      //----------------------------------------
   std::string fileSep = gpstom::getFileSep();
...
int RinexMet_T :: bitsAsStringTest()
{
   ...
   gpstom::RinexMetHeader RinexMetHeader;
...
int RinexMet_T :: reallyPutRecordTest()
{
   ...
   std::string msg_false_pass  =
      ", should have thrown a gpstom::Exception but did not.";
   std::string msg_fail        =
      ", should have thrown a gpstom::Exception but threw an unexpected exception.";
   std::string msg_test_detail = "";

   gpstom::RinexMetHeader RinexMetHeader;

   gpstom::RinexMetStream UnSupRinex( inputUnSupRinex.c_str() );
   gpstom::RinexMetStream MissingMarkerName( inputMissingMkr.c_str() );
   gpstom::RinexMetStream output( outputExtraOutput.c_str(),
                                 std::ios::out );
...
int RinexMet_T :: reallyGetRecordTest()
{
   ...
   SensorType.exceptions( std::fstream::failbit );
      ...
      //============================================================
      // Fail any of the following tests which does NOT throw a gpstom::Exception
      //============================================================
   ...
   std::string msg_fail_gpstk =
      ", should have thrown nothing, but threw a gpstom::Exception.";
...
int RinexMet_T :: convertObsTypeSTRTest()
{
   ...
   gpstom::RinexMetHeader::RinexMetType PR = RinexMetHeader.convertObsType( "PR" );
   gpstom::RinexMetHeader::RinexMetType TD = RinexMetHeader.convertObsType( "TD" );
   gpstom::RinexMetHeader::RinexMetType HR = RinexMetHeader.convertObsType( "HR" );
   gpstom::RinexMetHeader::RinexMetType ZW = RinexMetHeader.convertObsType( "ZW" );
   gpstom::RinexMetHeader::RinexMetType ZD = RinexMetHeader.convertObsType( "ZD" );
   gpstom::RinexMetHeader::RinexMetType ZT = RinexMetHeader.convertObsType( "ZT" );
   gpstom::RinexMetHeader::RinexMetType HI = RinexMetHeader.convertObsType( "HI" );
      // gpstom::RinexMetHeader::RinexMetType KE = RinexMetHeader.convertObsType( "HI" );
...
int RinexMet_T :: convertObsTypeHeaderTest()
{
   ...
   gpstom::RinexMetHeader::RinexMetType ZD = RinexMetHeader.convertObsType( "ZD" );
   gpstom::RinexMetHeader::RinexMetType ZT = RinexMetHeader.convertObsType( "ZT" );
      // gpstom::RinexMetHeader::RinexMetType KE = RinexMetHeader.convertObsType( "ZT" );
   ...
   testFramework.assert( ZTS == RinexMetHeader.convertObsType(ZT),
      ...
      //----------------------------------------
   msg_test_desc = "convertObsType( \"KE\" ), should throw  gpstom::FFStreamError";
...
int RinexMet_T :: hardCodeTest()
{
   ...
   gpstom::RinexMetStream testRinexMetStream( inputNormal.c_str() );
   gpstom::RinexMetStream out( outputHardCode.c_str(), std::ios::out );
   gpstom::RinexMetHeader testRinexMetHeader;
   ...
   gpstom::RinexMetData testRinexMetData;
   testRinexMetStream >> testRinexMetData;
   gpstom::CivilTime TimeGuess(2004,4,19,0,0,0);
   ...
   testFramework.assert( testRinexMetData.time == (gpstom::CommonTime)TimeGuess,
                         msg_test_desc + msg_test_fail, __LINE__ );
   ...
   testRinexMetStream >> testRinexMetData;
   gpstom::CivilTime TimeGuess2(2004,4,19,0,15,0);

   msg_test_fail = "RinexMetData.time did not equal TimeGuess2";
   testFramework.assert( testRinexMetData.time == (gpstom::CommonTime)TimeGuess2,
                         msg_test_desc + msg_test_fail, __LINE__ );
   ...
   gpstom::RinexMetStream MetDumps( outputDumps.c_str(), std::ios::out );
...
int RinexMet_T :: continuationTest()
{
   ...
   gpstom::RinexMetStream RinexMetStream( inputContLines.c_str() );
   gpstom::RinexMetStream out( outputContLines.c_str(), std::ios::out );
   gpstom::RinexMetStream MetDumps( outputDumps.c_str(), std::ios::out );
   gpstom::RinexMetHeader RinexMetHeader;
   gpstom::RinexMetData RinexMetData;
...
//
// Note: assuming this means that these test SHOULD throw a gpstom::Exception
// Throwing any exception other than gpstom::Exception is considered a failure.
...
int RinexMet_T :: dataExceptionsTest()
{
   ...
   gpstom::RinexMetStream NoObs( inputNoObs.c_str() );
   gpstom::RinexMetStream InvalidTimeFormat( inputInvTimeFmt.c_str() );
   gpstom::RinexMetStream out( outputExceptions.c_str(), std::ios::out );
   gpstom::RinexMetHeader rmh;
   gpstom::RinexMetData rme;
...
int RinexMet_T :: filterOperatorsTest()
{
   ...
   try
   {
      ...
      gpstom::RinexMetStream FilterStream1( inputFilterTest1.c_str() );
      FilterStream1.open( inputFilterTest1.c_str(), std::ios::in );
      gpstom::RinexMetStream FilterStream2( inputFilterTest2.c_str() );
      gpstom::RinexMetStream FilterStream3( inputFilterTest3.c_str() );
      gpstom::RinexMetStream out( outputFilterTest.c_str(), std::ios::out );

      gpstom::RinexMetHeader FilterHeader1;
      gpstom::RinexMetHeader FilterHeader2;
      gpstom::RinexMetHeader FilterHeader3;

      gpstom::RinexMetData FilterData1;
      gpstom::RinexMetData FilterData2;
      gpstom::RinexMetData FilterData3;
      gpstom::RinexMetData rmdata;
      ...
      gpstom::RinexMetHeaderTouchHeaderMerge merged;
      merged( FilterHeader1 );
      merged( FilterHeader2 );
      gpstom::RinexMetDataOperatorLessThanFull( merged.obsSet );
      out << merged.theHeader;

      gpstom::RinexMetDataOperatorEqualsSimple EqualsSimple;
      ...
      gpstom::RinexMetDataOperatorLessThanSimple LessThanSimple;
      msg_test_fail =
      ...
      gpstom::RinexMetDataOperatorLessThanFull LessThanFull(merged.obsSet);
      ...
      gpstom::CivilTime Start = gpstom::CommonTime::END_OF_TIME;
      gpstom::CivilTime End = gpstom::CommonTime::BEGINNING_OF_TIME;
      gpstom::CivilTime Start2 = gpstom::CommonTime::BEGINNING_OF_TIME;
      gpstom::CivilTime End2 = gpstom::CommonTime::END_OF_TIME;
      gpstom::RinexMetDataFilterTime FilterTime(Start,End);
      gpstom::RinexMetDataFilterTime FilterTime2(Start2,End2);
...
bool makeAndCompare(string inFile, string outFile, string expFile, double outVersion)
{
   ...
   gpstom::RinexMetStream inStream( inFile.c_str() );
   gpstom::RinexMetStream outStream( outFile.c_str(), std::ios::out );
   gpstom::RinexMetHeader testHeader;
