...
#ifndef GPSTOM_BRCKEPLERORBIT_HPP
#define GPSTOM_BRCKEPLERORBIT_HPP
...
namespace gpstom
{
   ...
   public:
      ...
      double getIDot() const throw(gpstom::InvalidRequest);
          ...
          */
      Xvt svXvt(const CommonTime& t) const throw(gpstom::InvalidRequest);
