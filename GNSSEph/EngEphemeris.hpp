...
#ifndef GPSTOM_EngEphemeris_HPP
#define GPSTOM_EngEphemeris_HPP
...
namespace gpstom
{
   ...
   public:
      ...
      BrcKeplerOrbit getOrbit() const throw(gpstom::InvalidRequest);

      BrcClockCorrection getClock() const throw(gpstom::InvalidRequest);
