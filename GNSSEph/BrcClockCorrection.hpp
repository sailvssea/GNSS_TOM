...
#ifndef GPSTOM_BRCLOCKCORRECTION_HPP
#define GPSTOM_BRCLOCKCORRECTION_HPP
...
namespace gpstom
{
   ...
   public:
	 ...
	 /// General purpose constructor
      ...
      CommonTime getEpochTime() const throw(gpstom::InvalidRequest);
      ...
      short getURAoc(const short& ndx) const throw(gpstom::InvalidRequest);
      ...
      short getFullWeek() const throw(gpstom::InvalidRequest);
          ...
          * week. */
      double getToc() const throw(gpstom::InvalidRequest);

         /** This function returns the SV clock error in seconds. */
      double getAf0() const throw(gpstom::InvalidRequest);

         /**
          * This function returns the SV clock drift in
          * seconds/seconds. */
      double getAf1() const throw(gpstom::InvalidRequest);

         /**
          * This function returns the SV clock rate of change of the
          * drift in seconds/(seconds*seconds). */
      double getAf2() const throw(gpstom::InvalidRequest);
