...
namespace gpstom
{
                          ...
                          const string& fmt )
   {
      ...
      {
         string rv( fmt );
         try {rv = ANSITime(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = CivilTime(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = GPSWeekSecond(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = GPSWeekZcount(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = JulianDate(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = MJD(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = UnixTime(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = PosixTime(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = YDSTime(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = GALWeekSecond(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = BDSWeekSecond(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = QZSWeekSecond(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         try {rv = IRNWeekSecond(t).printf( rv );} catch (gpstom::InvalidRequest e){};
         return rv;
      }
      catch( gpstom::StringUtils::StringException& se )
      {
         GPSTOM_RETHROW( se );
      }
   }
                  ...
                  const string& fmt )
   {
      ...
      catch( gpstom::InvalidRequest& ir )
      {
         GPSTOM_RETHROW( ir );
      }
      catch( gpstom::StringUtils::StringException& se )
