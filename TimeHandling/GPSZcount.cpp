...
using namespace std;
using gpstom::StringUtils::asString;
...
namespace gpstom
{
                        ...
                        long inZcount)
   {
      ...
      catch(gpstom::InvalidParameter& ip)
      {
         GPSTOM_RETHROW(ip);
      }
   }
   ...
   GPSZcount& GPSZcount::setWeek(short inWeek)
   {
      if( inWeek < 0 )
      {
         gpstom::InvalidParameter ip("GPS Week invalid: " +
   ...
   GPSZcount& GPSZcount::setZcount(long inZcount)
   {
      ...
      {
         gpstom::InvalidParameter ip("GPS Z-count invalid: " +
