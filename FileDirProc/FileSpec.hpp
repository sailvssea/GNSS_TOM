...
#ifndef GPSTOM_FILESPEC_HPP
#define GPSTOM_FILESPEC_HPP
...
namespace gpstom
{
   ...
   NEW_EXCEPTION_CLASS(FileSpecException, gpstom::Exception);
   ...
   public:
      ...
      virtual bool hasField(const FileSpecType) const
          ...
          */
      virtual gpstom::CommonTime extractCommonTime(const std::string& filename)
         const
         throw(FileSpecException);
          ...
          */
      virtual std::string toString(const gpstom::CommonTime& dt,
